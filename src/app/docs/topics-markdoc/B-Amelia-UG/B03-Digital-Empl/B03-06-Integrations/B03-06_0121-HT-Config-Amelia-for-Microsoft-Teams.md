...
</chapter> **Note:** <chapter title="Configure the Azure Bot" collapsible="true" level="5">
...
1. Select **Single Tenant** from the Type of App dropdown list.
   > As of July 31, 2025, Microsoft no longer supports creating new Mult Tenant apps.
...
</chapter> **Note:** #### Optional Bot Push Notification Permissions
...
</chapter> **Note:** #### Test the Connection to Amelia
