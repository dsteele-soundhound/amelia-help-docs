...
When you manually create an automation in Automation Studio, Autonomics adds a Start and a Success action. You can then add one or more Task Lifecycle actions between these points to develop your automation. Autonomics performs actions in the order that you add them to each automation---top to bottom or left to right. It's an optional action in the automation.

Adding a Task Lifecycle action is simple. The Task Lifecycle button is on the Actions panel. Click the button, then click your mouse anywhere on the canvas to add the action. Once added, you can reposition and connect it as needed.

![E02-01_0037-Automations-Task-Lifecycle-Action](E02-01_0037-Automations-Task-Lifecycle-Action.png){width="600" style="block"}

*The Task Lifecycle Action
...
When you add a Task Lifecycle action to the Automation Studio canvas, a Choose Automaton modal displays. For more information on this modal, refer to the section [Adding an Action](#Adding) below. After selecting a process, you're returned to the canvas and your Task Lifecycle action.

Clicking the Task Lifecycle action displays a popup toolbar above the action. Using the popup toolbar, click the Properties ( ![Properties-Btn-Automation_Studio_Action_Tbar](Properties-Btn-Automation_Studio_Action_Tbar.png){width="25" style="inline"}) button. The properties panel has tabs with settings to configure.
...
![E02-01_0037-Automations-Task-Lifecycle-StateProperties](E02-01_0037-Automations-Task-Lifecycle-StateProperties.png){width="600" style="block"}
...
<tr>
    ...
    <td>Type the name of the action. Clicking Delete ( x ) clears the field. Autonomics assigns it the default name of "Task Lifecycle".</td>
</tr>
<tr>
    <td>State Type</td>
    <td>Task LifecycleAction</td>
...
![E02-01-0037-Automations-Task-Lifecycle-ExtractVariables.png](E02-01-0037-Automations-Task-Lifecycle-ExtractVariables.png){width="600" style="block"}
...
![E02-01_0037-Automations-Task-Lifecycle-StateNotes.png](E02-01_0037-Automations-Task-Lifecycle-StateNotes.png){width="600" style="block"}
...
When you manually create an automation using Automation Studio, Autonomics adds a Start and a Success action to help you get started. You can then add actions between these points to develop your automation. Adding a Task Lifecycle action is simple.

To add a Task Lifecycle action to your Automation Studio canvas:

1. On the left of the Automation Studio canvas, find the Actions panel.
2. Click the Task Lifecycle (&nbsp;&nbsp;![TaskLifecycle-Btn-Auto_Studio_ActionsPanel](TaskLifecycle-Btn-Auto_Studio_ActionsPanel.png){width="18" style="inline"}&nbsp;) button. You'll see your mouse pointer change to a hand, and a floating Task Lifecycle action appears. The orange color lets you know that this action hasn't been added and positioned.
3. Drop your new Task Lifecycle action on the canvas. Once added, you can reposition and connect your new Task Lifecycle action as needed. When you add the action to canvas, the Choose Automation modal shows.
...
Keep this best practice in mind as you work with the Task Lifecycle action:
