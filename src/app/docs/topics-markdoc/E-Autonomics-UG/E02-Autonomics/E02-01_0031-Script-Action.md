...
> **Note:** As of Autonomics 3.10.0, Python is supported for basic Python syntax and standard libraries. **It currently is an experimental feature.** Contact your program manager to enable Python support. <br /><br />Future releases would include the ability to import and use external Python libraries in Script actions. And the ability to restrict Python access to file systems, network resources, and sensitive system components.
