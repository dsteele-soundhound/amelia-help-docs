    ...
    <DocsLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
        <div className="card">
          ...
          <a href="/docs/A-Getting-Started-Amelia" className="text-primary-400 hover:text-primary-500 font-medium">
            Read more →
          </a>
        </div>
        ...
        <div className="card">
          ...
          <a href="/docs/B-Amelia-UG" className="text-primary-400 hover:text-primary-500 font-medium">
            Read more →
          </a>
        </div>
        ...
        <div className="card">
          ...
          <a href="/docs/C-Amelia-Ops" className="text-primary-400 hover:text-primary-500 font-medium">
            Read more →
          </a>
        </div>
      </div>
